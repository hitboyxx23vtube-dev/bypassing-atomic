...
let history = [];
let historyIndex = 0;
let currentMedia = null; // audio/video/iframe element
let globalVolume = 50; // default 50%

// Append lines to <pre> output
function typeLine(text) {
  output.textContent += text + "\n";
  output.scrollTop = output.scrollHeight;
}

// Stop any current media playback and remove it
function stopMedia() {
  if (currentMedia) {
...
// Play video or YouTube at global volume
...
// Command history navigation and enter handler
